...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="form-check">
            <div class="row">
                <div class="col-6">
                    <input type="radio" class="btn-check" name="options-outlined" id="choices-1" value="1" autocomplete="off">

                    <label class="btn btn-outline-primary w-100 p-3 mt-4" for="choices-1">1.{{$quiz->quizzes[$number]->answer1}}</label>

                </div>
                <div class="col-6">
                    <input type="radio" class="btn-check" name="options-outlined" id="choices-2" value="2" autocomplete="off">
            ...
            <div class="row">
                <div class="col-6">
                    <input type="radio" class="btn-check" name="options-outlined" id="choices-3" value="3" autocomplete="off">

                    <label class="btn btn-outline-primary w-100 p-3 mt-3" for="choices-3">3.{{$quiz->quizzes[$number]->answer3}}</label>

                </div>
                <div class="col-6">
                    <input type="radio" class="btn-check" name="options-outlined" id="choices-4" value="4" autocomplete="off">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h4 class="text-center text-dark font-weight-bold">正解は{{$quiz->quizzes[$number]->answer}}番です。<h4>
                    ...
                    <input id="quiz" type="hidden" class="form-control @error('quiz') is-invalid @enderror" placeholder="選択肢４を入力してください" 
                    ...
                    <input id="title" type="hidden" class="form-control @error('title') is-invalid @enderror" placeholder="選択肢４を入力してください" 
